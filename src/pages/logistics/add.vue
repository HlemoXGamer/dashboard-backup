<script setup>
import { create } from "@/apis/admin/logistics";
import {
  emailValidator,
  kuwaitValidator,
  requiredValidator,
...
<template>
  <VRow class="mt-4 px-4" justify="space-around">
    <VCol class="pt-0">
      ...
      >
        <p class="text-h4 pt-3 pb-2">{{ $t('Add Logistic') }}</p>
        <VForm ref="refVForm" @submit.prevent="_addLogistic">
          <VCol>
