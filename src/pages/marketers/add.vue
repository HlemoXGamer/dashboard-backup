<script setup>
import { create } from "@/apis/admin/markters";
import {
  emailValidator,
  integerValidator,
  kuwaitValidator,
...
<template>
  <VRow class="mt-4 px-4" justify="space-around">
    <VCol class="pt-0">
      ...
      >
        <p class="text-h4 pt-3 pb-2">{{ $t('Add Marketer') }}</p>
        <VForm ref="refVForm" @submit.prevent="_addMarketer">
          <VCol>
